#!/system/bin/sh
if ! applypatch --check EMMC:/dev/block/platform/bootdevice/by-name/recovery:33554432:005126924d7abdbd68dcf0c9daf22caaef7c3b47; then
  applypatch \
          --patch /system/recovery-from-boot.p \
          --source EMMC:/dev/block/platform/bootdevice/by-name/boot:33554432:2f21c208979eed465bb5c576f06c9bb886a19746 \
          --target EMMC:/dev/block/platform/bootdevice/by-name/recovery:33554432:005126924d7abdbd68dcf0c9daf22caaef7c3b47 && \
